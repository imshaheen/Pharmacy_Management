<?php
  ...
  function addStock() {
    ...
    if($con) {
      ...
      if($row) {
        ...
        $query = "INSERT INTO medicines_stock (NAME, BATCH_ID, EXPIRY_DATE, QUANTITY, INVOICE_NUMBER) VALUES('$name', '$batch_id', '$expiry_date', $quantity, $invoice_number)";
        $result = mysqli_query($con, $query);
      }
    }
  }
  ...
  function createMedicineInfoRow() {
      ...
      <div class="row col col-md-12">
        ...
        <div class="col col-md-2">
          <input type="number" class="form-control" placeholder="0" id="quantity_<?php echo $row_number; ?>" name="quantity">
