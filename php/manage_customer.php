...
function showEditOptionsRow($seq_no, $row) {
  ...
  <tr>
    ...
    <td><?php echo $row['ID'] ?></td>
    <td>
      <input type="text" class="form-control" value="<?php echo $row['NAME']; ?>" placeholder="Employee ID" id="customer_name" onkeyup="validateName(this.value, 'name_error');">
      <code class="text-danger small font-weight-bold float-right" id="name_error" style="display: none;"></code>
    </td>
    <td>
      <input type="text" class="form-control" value="<?php echo $row['CONTACT_NUMBER']; ?>" placeholder="Employee Name" id="customer_contact_number" onblur="validateContactNumber(this.value, 'contact_number_error');">
      <code class="text-danger small font-weight-bold float-right" id="contact_number_error" style="display: none;"></code>
    </td>
    <td>
      <input type="text" class="form-control" placeholder="Designation" id="customer_address" onblur="validateAddress(this.value, 'address_error');" value="<?php echo $row['ADDRESS']; ?>">
      <!-- <textarea ></textarea> -->
      <code class="text-danger small font-weight-bold float-right" id="address_error" style="display: none;"></code>
    </td>
    <td>
      <input type="text" class="form-control" value="<?php echo $row['DOCTOR_NAME']; ?>" placeholder="Section" id="customer_doctors_name" onkeyup="validateAddress(this.value, 'doctor_name_error');">
      <code class="text-danger small font-weight-bold float-right" id="doctor_name_error" style="display: none;"></code>
    </td>
    <td>
      <input type="text" class="form-control" placeholder="Division" id="customer_doctors_address" onblur="validateAddress(this.value, 'doctor_address_error');" value="<?php echo $row['DOCTOR_ADDRESS']; ?>">
      <!-- <textarea ></textarea> -->
