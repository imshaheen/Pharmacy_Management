        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              ...
              <input type="date" class="datepicker form-control hasDatepicker" id="invoice_date" name="invoice_date" value='<?php echo date('d-m-Y'); ?>' onblur="checkDate(this.value, 'date_error');">
          ...
          <div class="row col col-md-12 font-weight-bold">
            ...
            <div class="col col-md-2">Packing</div>
